...
import { CrearRestaurantte } from './components/pages/home/crear-restaurantte/crear-restaurantte';
...
export const routes: Routes = [
    ...
    { path: 'restaurantes/restaurante/:id', title: "Restaurantes", component: Restaurante },
    { path: 'restaurantes/crear-restaurante', title: "Restaurantes", component: CrearRestaurantte },
