...
export class AuthService {
	...
	private readonly http = inject(HttpClient); // Cliente HTTP para peticiones a la API
	private readonly router = inject(Router);   // Router para redirecciones
    ...
    // Falta implementar: métodos auxiliares para cookies, logout y manejo de errores
