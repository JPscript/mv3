...
|---|---|---|
| `experto-html` | `/.github/skills/experto-html` | Crear/revisar HTML semántico y formularios básicos. |
| `experto-css` | `/.github/skills//experto-css` | Crear/revisar estilos, layout y responsive. |
| `diseno-ejercicios-sin-ia` | `/.github/skills//diseno-ejercicios-sin-ia` | Diseñar ejercicios guiados y progresivos para `sin-ia`. |
| `diseno-ejercicios-con-ia` | `/.github/skills//diseno-ejercicios-con-ia` | Diseñar ejercicios más avanzados con prompts para `con-ia`. |
| `guia-avance-clase` | `/.github/skills//guia-avance-clase` | Crear guía de sesión con tiempos, receso y entregables. |
| `revision-ejercicios-alumno` | `/.github/skills//revision-ejercicios-alumno` | Revisar entregas y dar feedback técnico + motivación. |
| `commit-profesional` | `/.github/skills/commit-profesional` | Proponer commits atómicos y mensajes profesionales. |