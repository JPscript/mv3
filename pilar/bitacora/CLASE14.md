...
Durante esta sesión comenzamos a trabajar con la API de restaurantes, aprendiendo primero a comprobar su funcionamiento antes de integrarla en el proyecto.

Utilizamos Postman para probar los endpoints de la API. Esto nos permitió verificar que las rutas funcionaban correctamente y entender qué datos devuelve el backend en formato JSON.

# Predicción próxima clase

- Mostrar los restaurantes en pantalla de forma dinámica.
...
- [x] API preparada para aplicar los datos en la aplicación de restaurantes.
