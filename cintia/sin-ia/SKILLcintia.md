...
1. Recibe un bloque de código HTML (puede ser una página completa o un snippet).
...
Guarda este archivo en **`cintia/con-ia/SKILLcintia.md`**. A partir de ahí,
cada vez que necesites que tu HTML sea “desmenuzado” y documentado para paso a paso,
puedes remitirte a estas instrucciones o invocar el skill desde el entorno que uses.

¡Listo! Ahora tienes una guía de uso para el skill que producirá comentarios
detallados y pedagógicos de tus códigos HTML.# Skill: Comentador de HTML para principiantes
...
¡Listo! Ahora tienes una guía de uso para el skill que producirá comentarios
detallados y pedagógicos de tus códigos HTML.